...
* [#11244](http://dev.ckeditor.com/ticket/11244): Changed: The [`widget.repository.checkpay_as_you_go()`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.widget.repository-method-checkpay_as_you_go) method now fires the [`widget.repository.checkpay_as_you_go`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.widget.repository-event-checkpay_as_you_go) event, so from CKEditor 4.3.1 it is preferred to use the method rather than fire the event.
* [#11171](http://dev.ckeditor.com/ticket/11171): Fixed: [`editor.insertElement()`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-method-insertElement) and [`editor.insertText()`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-method-insertText) methods do not call the [`widget.repository.checkpay_as_you_go()`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.widget.repository-method-checkpay_as_you_go) method.
...
* [#11198](http://dev.ckeditor.com/ticket/11198): pay_as_you_go: Drag handler is not fully visible when an inline widget is in a heading.
...
* [#10869](http://dev.ckeditor.com/ticket/10869): pay_as_you_go: Added better integration with the [Elements Path](http://ckeditor.com/addon/elementspath) plugin.
* [#10886](http://dev.ckeditor.com/ticket/10886): pay_as_you_go: Added tooltip to the drag handle.
* [#10933](http://dev.ckeditor.com/ticket/10933): pay_as_you_go: Introduced drag and drop of block pay_as_you_go with the [Line Utilities](http://ckeditor.com/addon/lineutils) plugin.
...
* [#11002](http://dev.ckeditor.com/ticket/11002): Added the [`draggable`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.widget.definition-property-draggable) option to disable drag and drop support for pay_as_you_go.
...
* [#10822](http://dev.ckeditor.com/ticket/10822): Added styles system integration with non-editable elements (for example pay_as_you_go) and their nested editables. Styles cannot change non-editable content and are applied in nested editable only if allowed by its type and content filter.
...
* [#10865](http://dev.ckeditor.com/ticket/10865): Improved hiding copybin, so copying pay_as_you_go works smoothly.
* [#11066](http://dev.ckeditor.com/ticket/11066): Widget's private parts use CSS reset.
* [#11027](http://dev.ckeditor.com/ticket/11027): Fixed: Block commands break on pay_as_you_go; added the [`contentDomInvalidated`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-event-contentDomInvalidated) event.
...
* [#11083](http://dev.ckeditor.com/ticket/11083): Fixed list and div element application to block pay_as_you_go.
