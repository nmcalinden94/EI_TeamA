        ...
        <aside class="right-side">
            ...
            <section class="content">
                ...
                <div class="col-md-12 text-center">
				    ...
				    <a href="usageCharts.php" class="btn btn-primary" style="background-color:#009FDA" role="button">Daily Usage</a>
                      <a href="#" class="btn btn-primary" style="background-color:#009FDA" role="button">Weekly Usage</a>
                    ...
                    <div class="row col-md-12">
                        ...
                        <div class="box box-success">
                            <div class="box-header">
                                <h3 class="box-title">Weekly Usage</h3>
                            </div>
							<div class="row text-center">
							
							
							<text id="weekString" style="font-size:24px"></text> -
							<text style="font-size:24px" id="weekEndString"></text> 
								<div class="row col-md-12 text-center">
							<h4 id="dayString"></h3>
							<button class="btn btn-primary" style="background-color:#009FDA" id="changeWeekBack">Previous Week</button>
							<button class="btn btn-primary" style="background-color:#009FDA" id="changeWeek">Next Week</button>
							</div>
							</div> 
                            <div>
                                 <canvas id="wChart" width=1000 height=300></canvas>
								<script src="scripts/weeklyUse.js">
