            ...
            <section class="content">
                ...
                <div class="col-md-12 text-center">
				    ...
				    <a href="usageCharts.php" class="btn btn-primary" style="background-color:#009FDA" role="button">Daily Usage</a>
                      ...
                      <a href="#" class="btn btn-primary" style="background-color:#009FDA" role="button">Monthly Usage</a>
                    </div>
                                ...
                                <div class="row col-md-12 ">
                                    ...
                                    <div class="box box-info">
                                        <div class="box-header">
                                            <h3 class="box-title"> Monthly Usage</h3>
                                        </div>
										
										
                                       <div>
                                 <canvas id="dChart" width=1000 height=300></canvas>
											<script src="scripts/monthlyUse.js">
