...
<head>
    <meta charset="UTF-8">
    <title>Electric Ireland | Top-Up Failed</title>
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-danger">
                        <div class="box-header">
                            <h2 class="box-title">Payment Failed</h2>
                        </div><!-- /.box-header -->

                        <div class="box-body danger" style="overflow-y: auto;">
                            <form class="form" method="post">              
                            <div class="col-md-12 text-center">
                                <div class="alert alert-danger">
                                    <i class="fa fa-ban"></i>                                       
                                    <b>Error!</b> Your Top Up Was Unsuccessful.
                                </div>
                            </div>
                            
                            <h4><font color="009FDA">Top-Up Details</font></h5>
                            <p>Your top-up of £
                            <?php echo $_SESSION['pricetype']; echo $_GET['pricetype'];?> 
                            was unsuccessful & will not debited from your account.</p>
                            </br>
                            <p><b>Please ensure your details are correct & try again.</b></p>
                                <!-- this row will not appear when printing -->
                    			<div class="row no-print">
                        			<div class="col-xs-12 text-center">
                        				<a href="../../index.php" class="btn btn-danger"><i class="fa fa-home"></i> Home</a>
                        				<a href="pay_as_you_go.php" class="btn btn-danger"><i class="fa fa-arrow-circle-left"></i> Back</a>
