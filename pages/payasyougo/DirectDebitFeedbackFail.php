...
<head>
    <meta charset="UTF-8">
    <title>Electric Ireland | Direct Debit Failed</title>
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>
						...
						?></bold></label>
                        <small>Direct Debit | Failed</small>
                    </h1>
                <ol class="breadcrumb">
                            ...
                            <form class="form">             
                            	<div class="col-md-12 text-center">
                                    <div class="alert alert-danger">
                                        <i class="fa fa-ban"></i>                                       
                                        <b>Error!</b> Your Direct Debit Was Unsuccessful.
                                    </div>
                                </div>
                            
                            <h4><font color="009FDA">Direct Debit Details</font></h5>
							<p>Your payment of £<?php echo $_GET['debittype'];?> will <b>NOT</b> be taken by us on the <?php echo $_GET['directdebitdate3id'];?>.</p>
                            <br/>
                            </br>
