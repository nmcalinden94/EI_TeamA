...
<head>
    <meta charset="UTF-8">
    <title>Electric Ireland | Top-Up Successful</title>
    ...
    <!-- globals -->
	<script src="../../js/EI/EI_TopUpPDF.js" type="text/javascript"></script>
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>
						...
						?></bold></label>
                        <small>Top-Up | Confirmation</small>
                </h1>
                <ol class="breadcrumb">
                        ...
                        <div class="box-body success" style="overflow-y: auto;">
                            ...
                            <div class="col-md-12 text-center">
                                <div class="alert alert-success">
                                    ...
                                    <b>Congratulations!</b> You have successfully Topped Up.
                                </div>
                            </div>
                            
                            <h4><font color="009FDA">Top-Up Details</font></h5>
                            <p>Your top-up of £
                            <?php echo $_GET['pricetype'];?> 
                            was successful & will be debited from your account immediately. </p>
                            </br>
                            <h4 class="box-title"><font color="009FDA">Top-Up Summary</font></h3>                                    
                                <div class="box-body table-responsive">
                                    <table id="Top-UpSummary" class="table table-bordered table-hover">                                   
                                        <tbody>
                                            <tr>
