...
<head>
    <meta charset="UTF-8">
    <title>Electric Ireland | Message Unsuccessful</title>
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>
						...
						?></bold></label>
                        <small>Message | Unsuccessful</small>
                    </h1>
                <ol class="breadcrumb">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-danger">
                        <div class="box-header">
                            <h2 class="box-title">Message Failed</h2>
                        </div><!-- /.box-header -->
                            ...
                            <form class="form">             
                            	<div class="col-md-12 text-center">
                                    <div class="alert alert-danger">
                                        <i class="fa fa-ban"></i>                                       
                                        <b>Failed!</b> Your message was not successfully sent.
                                        Please try again.
                                    </div>
                                </div>
                            <br/>
